...
document.body.style.cssText = `
  ...
  align-items: center; 
            background-image: url('https://tse1.mm.bing.net/th/id/OIP.LWL9E9FPtmQWNRWTGq4_1gHaE8?pid=Api');
...
const cards = [
  ...
  {name: "Валет", id: 2, src: 'https://deckofcardsapi.com/static/img/JD.png'},
  {name: "Дама", id: 3, src: 'https://deckofcardsapi.com/static/img/QD.png'},
  {name: "Король", id: 4, src: 'https://deckofcardsapi.com/static/img/KC.png'},
  {name: "Туз", id: 11, src: 'https://deckofcardsapi.com/static/img/AC.png'}
];
